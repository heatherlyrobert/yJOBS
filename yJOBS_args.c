...
static const tOPTS   s_opts [MAX_OPTS] = {
   ...
   /*---(incomming 5)--------------------*/
   { "verify"   , "v—V", "verify local file for correctness"            ,   4, '-', YJOBS_LOCAL    },
   { "local"    , "lÚL", "report on local file content"                 ,   5, '-', YJOBS_LOCAL    },
   { "register" , "bÈB", "verify local file and register centrally"     ,   6, '-', YJOBS_LOCAL    },
   { "update"   , "u˚U", "update central with single local file"        ,   7, '-', YJOBS_LOCAL    },
   { "install"  , "iI", "verify local file, then update centrally"     ,   8, '-', YJOBS_LOCAL    },
   /*---(maintain 6)---------------------*/
   { "stats"    , "#∑∑", "information about database and environment"   ,  10, '-', YJOBS_CENTRAL  },
   { "list"     , "=∑∑", "list of executable content"                   ,  11, '-', YJOBS_CENTRAL  },
   { "report"   , "mÛM", "report on central database"                   ,  12, '-', YJOBS_CENTRAL  },
   { "check"    , "c˝C", "check central file for correctness"           ,  13, '-', YJOBS_CENTRAL  },
   { "audit"    , "aËA", "audit central environment and all its files"  ,  14, '-', YJOBS_CENTRAL  },
   { "fix"      , "f¸F", "audit central environment and fix issues"     ,  15, '-', YJOBS_CENTRAL  },
   { "only"     , "oˆO", "run on single central data file"              ,  16, 'y', YJOBS_CENTRAL  },
   /*---(epic)---------------------------*/
   { "backup"   , "kÒK", "backup the central system"                    ,  18, '-', YJOBS_CENTRAL  },
   { "restore"  , "t˙T", "restore the central system from backup"       ,  19, '-', YJOBS_CENTRAL  },
   { "purge"    , "wˇW", "wipe clean entire central system"             ,  20, '-', YJOBS_CENTRAL  },
   /*---(elsewhere)----------------------*/
   { "upload"   , "yÔY", "from elsewhere to central"                    ,  22, '-', YJOBS_CENTRAL  },
   { "download" , "zÌZ", "from central to elsewhere"                    ,  23, '-', YJOBS_CENTRAL  },
   /*---(outgoing 4)---------------------*/
   { "withdraw" , "q˛Q", "unregister centrally"                         ,  25, '-', YJOBS_CENTRAL  },
   { "clear"    , "xıX", "clear file from central location"             ,  26, '-', YJOBS_CENTRAL  },
   { "remove"   , "r¯R", "unregister and clear from central location"   ,  27, '-', YJOBS_CENTRAL  },
   { "extract"  , "eÏE", "extract a central file to local copy"         ,  28, '-', YJOBS_CENTRAL  },
   /*---(execution)----------------------*/
   { "gather"   , "gÍG", "execute system-wide data gather"              ,  30, '-', YJOBS_NEITHER  },
   { "daemon"   , "dÎD", "execute specific file in daemon-mode"         ,  31, 'y', YJOBS_NEITHER  },
   { "prickly"  , "p˜P", "execute specific file in prickly daemon-mode" ,  32, 'y', YJOBS_NEITHER  },
   { "normal"   , "nÙN", "execute specific file in normal-mode"         ,  33, 'y', YJOBS_NEITHER  },
   { "strict"   , "s˘S", "execute specific file in strict normal-mode"  ,  34, 'y', YJOBS_NEITHER  },
   { "reload"   , "hÓH", "send signal to reload daemon"                 ,  35, '-', YJOBS_NEITHER  },
   /*---(unit testing)-------------------*/
