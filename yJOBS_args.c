...
static const tOPTS   s_opts [MAX_OPTS] = {
   ...
   /*---(epic)---------------------------*/
   { "backup"   , "kÒK", "backup the central system"                    ,  17, '-', YJOBS_CENTRAL  },
   { "restore"  , "t˙T", "restore the central system from backup"       ,  18, '-', YJOBS_CENTRAL  },
   { "purge"    , "wˇW", "wipe clean entire central system"             ,  19, '-', YJOBS_CENTRAL  },
   /*---(elsewhere)----------------------*/
   { "upload"   , "yÔY", "from elsewhere to central"                    ,  21, '-', YJOBS_CENTRAL  },
   { "download" , "zÌZ", "from central to elsewhere"                    ,  22, '-', YJOBS_CENTRAL  },
   /*---(outgoing 4)---------------------*/
   { "withdraw" , "q˛Q", "unregister centrally"                         ,  24, '-', YJOBS_CENTRAL  },
   { "clear"    , "xıX", "clear file from central location"             ,  25, '-', YJOBS_CENTRAL  },
   { "remove"   , "r¯R", "remove file from central location"            ,  26, '-', YJOBS_CENTRAL  },
   { "extract"  , "eÏE", "extract a central file to local copy"         ,  27, '-', YJOBS_CENTRAL  },
   /*---(execution)----------------------*/
   { "gather"   , "gÍG", "execute system-wide data gather"              ,  29, '-', YJOBS_NEITHER  },
   { "daemon"   , "dÎD", "execute specific file in daemon-mode"         ,  30, 'y', YJOBS_NEITHER  },
   { "prickly"  , "p˜P", "execute specific file in prickly daemon-mode" ,  31, 'y', YJOBS_NEITHER  },
   { "normal"   , "nÙN", "execute specific file in normal-mode"         ,  32, 'y', YJOBS_NEITHER  },
   { "strict"   , "s˘S", "execute specific file in strict normal-mode"  ,  33, 'y', YJOBS_NEITHER  },
   { "reload"   , "hÓH", "send signal to reload daemon"                 ,  34, '-', YJOBS_NEITHER  },
   /*---(unit testing)-------------------*/
