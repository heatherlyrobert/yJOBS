...
static const tOPTS   s_opts [MAX_OPTS] = {
   ...
   { "local"    , "lÚL", "report on local content"                      ,   5, '-', YJOBS_LOCAL    },
   { "register" , "bÈB", "verify local file and register centrally"     ,   6, '-', YJOBS_LOCAL    },
   { "update"   , "u˚U", "update central with single file"              ,   7, '-', YJOBS_LOCAL    },
   { "install"  , "iI", "verify local file, then install centrally"    ,   8, '-', YJOBS_LOCAL    },
   /*---(maintain 6)---------------------*/
   ...
   { "remove"   , "r¯R", "remove file from central location"            ,  27, '-', YJOBS_CENTRAL  },
