...
const tWHO  g_whos [MAX_WHO] = {
   ...
   {  IAM_KHRONOS    , IAM_UKHRONOS   , "khronos"  , "/usr/sbin/"         , "khronos-anileis (merciless time)"                  , "--· F···F ---F--· ··· ·· ·FFF ·----- -" , 'y', 'y', "/var/spool/khronos/"      , "/tmp/spool/khronos/"      , "khronos."   , "(USER)."    , ""           , ""                , "/var/lib/khronos/"        , "/tmp/lib/khronos/"        , ""                    , '·' , ""                    }, 
   ...
   {  IAM_GREGG      , IAM_UGREGG     , "gregg"    , "/usr/local/bin/"    , "athene-makhanitis (skilled inventor)"              , "-·· ·FF·· --FF--F ··· ·· F··· -··--· -" , 'y', 'y', "/var/lib/gregg/"          , "/tmp/lib/gregg/"          , ""           , ""           , ".dict"      , ""                , "/var/lib/gregg/"          , "/tmp/lib/gregg/"          , ""                    , '·' , "gregg.db"            }, 
